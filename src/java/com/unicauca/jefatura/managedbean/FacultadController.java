...
import com.unicauca.jefatura.sessionbean.FacultadFacade;
...
public class FacultadController implements Serializable {
    ...
    @EJB
    private com.unicauca.jefatura.sessionbean.FacultadFacade ejbFacade;
    ...
    @PostConstruct
    public void init(){
        selected = ejbFacade.buscarPorIdFacultad(9);
    }
