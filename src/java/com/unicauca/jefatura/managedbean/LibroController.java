...
import com.unicauca.jefatura.sessionbean.LibroFacade;
...
public class LibroController implements Serializable {
    ...
    @EJB
    private com.unicauca.jefatura.sessionbean.LibroFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle2").getString("LibroCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle2").getString("LibroUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle2").getString("LibroDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class LibroControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Libro) {
                ...
                return getStringKey(o.getLibroId());
            } else {
