...
import com.unicauca.jefatura.sessionbean.PaisFacade;
...
public class PaisController implements Serializable {
    ...
    @EJB
    private com.unicauca.jefatura.sessionbean.PaisFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle.comisiones").getString("PaisCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle.comisiones").getString("PaisUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle.comisiones").getString("PaisDeleted"));
        if (!JsfUtil.isValidationFailed()) {
